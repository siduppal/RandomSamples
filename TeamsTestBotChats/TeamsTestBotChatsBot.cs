...
namespace TeamsTestBotChats
{
    ...
    public class TeamsTestBotChatsBot : IBot
    {
        private readonly TeamsTestBotChatsAccessors _accessors;
        ...
        public TeamsTestBotChatsBot(TeamsTestBotChatsAccessors accessors, ILoggerFactory loggerFactory)
        {
            ...
            _logger = loggerFactory.CreateLogger<TeamsTestBotChatsBot>();
